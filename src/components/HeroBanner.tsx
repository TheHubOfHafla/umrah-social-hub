      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center">
        <div className="container mx-auto px-4">
          <div className={cn(
            ...
            <p className={cn(
              "text-xl font-heading text-[#D946EF] max-w-2xl mx-auto text-pretty transition-all duration-700 delay-200",
              contentVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            )}>
            ...
            {!isAuthenticated && (
              <div className={cn(
                ...
                <p className="font-sans text-[#F97316] text-lg mb-3 font-semibold">Create an account to track events, get personalized recommendations, and more</p>
                <Link to="/signup">
                  <Button 
                    variant="outline" 
