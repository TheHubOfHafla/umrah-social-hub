...
// Carousel images for the hero banner - reordering to make the 3rd image first
...
const HeroBanner = ({
  ...
  return (
    <section className="relative w-full overflow-hidden pt-14 px-0 pb-10 mx-0 my-0 flex flex-col items-center min-h-[90vh] isolate">
      ...
      <div className="text-center mt-16 mb-2 z-10 pt-8 md:pt-12">
      ...
      {/* Centered carousel with elevated z-index and increased height */}
