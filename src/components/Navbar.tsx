...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed inset-x-0 top-[57px] z-50 h-[calc(100vh-57px)] bg-background transition-transform duration-300 ease-in-out md:hidden",
      ...
      >
        <div className="container py-4">
          <div className="flex flex-col space-y-4">
            ...
            <Link
              to="/profile"
              className="px-4 py-3 text-lg rounded-md hover:bg-secondary/80 flex items-center"
            >
